...
public enum MatchEventType: Codable, Equatable {
  ...
  public var displayName: String {
    switch self {
    case .goal: "Goal"
    case let .card(details): details.cardType == .yellow ? "Yellow Card" : "Red Card"
    case .substitution: "Substitution"
    case .kickOff: "Kick Off"
    case let .periodStart(period): "Period \(period) Start"
    case .halfTime: "Half Time"
    case let .periodEnd(period): "Period \(period) End"
    case .matchEnd: "Match End"
    case .penaltiesStart: "Penalties Start"
    case let .penaltyAttempt(details):
      details.result == .scored ? "Penalty Scored" : "Penalty Missed"
    case .penaltiesEnd: "Penalties End"
    }
  }
}
...
extension MatchEventRecord {
  ...
  public var displayDescription: String {
    ...
    default:
      return self.eventType.displayName
    }
  }

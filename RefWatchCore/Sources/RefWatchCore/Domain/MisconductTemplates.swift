...
public struct MisconductTemplate: Identifiable, Hashable {
  ...
  public func reasons(
    ...
    recipient: CardRecipientType) -> [MisconductReason]
  {
    self.reasons.filter { $0.cardType == cardType && $0.recipientType == recipient }
  }

  public var allReasons: [MisconductReason] { self.reasons }
...
public enum MisconductTemplateCatalog {
  ...
  public static func template(for id: String?) -> MisconductTemplate {
    // Map legacy IDs to current ones for backward compatibility (e.g. previously mislabeled NSW actually pointed to VIC
    // reasons)
...
extension MisconductTemplateCatalog {
  ...
  fileprivate static var footballVictoria: MisconductTemplate {
    MisconductTemplate(
      id: "football_vic",
      ...
      reasons: [
        ...
        MisconductReason(
          id: "vic_y3",
          code: "Y3",
          title: "Persistent or Tactical Fouls",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "vic_y4",
          code: "Y4",
          title: "Delaying Restart of Play",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "vic_y5",
          code: "Y5",
          title: "Failure to Respect Required Distance",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "vic_y6",
          code: "Y6",
          title: "Entering/Leaving Without Permission",
          cardType: .yellow,
          recipientType: .player),
        ...
        MisconductReason(
          id: "vic_r4",
          code: "R4",
          title: "Denying Goal with Handball",
          cardType: .red,
          recipientType: .player),
        MisconductReason(
          id: "vic_r5",
          code: "R5",
          title: "Denying Goal-Scoring Opportunity",
          cardType: .red,
          recipientType: .player),
        MisconductReason(
          id: "vic_r6",
          code: "R6",
          title: "Abusive Language or Gestures",
          cardType: .red,
          recipientType: .player),
        ...
        MisconductReason(
          id: "vic_yt1",
          code: "YT1",
          title: "Persistent Irresponsible Behaviour",
          cardType: .yellow,
          recipientType: .teamOfficial),
        MisconductReason(
          id: "vic_yt2",
  ...
  fileprivate static var faEngland: MisconductTemplate {
    MisconductTemplate(
      id: "fa_england",
      name: "The FA",
      region: "England",
      ...
      reasons: [
        ...
        MisconductReason(
          id: "fa_c4",
          code: "C4",
          title: "Delaying the Restart of Play",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "fa_c5",
          code: "C5",
          title: "Failure to Respect the Required Distance",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "fa_c6",
          code: "C6",
          title: "Entering/Leaving FOP without Permission",
          cardType: .yellow,
          recipientType: .player),
        MisconductReason(
          id: "fa_c7",
          code: "C7",
          title: "Unsporting Behaviour – Other",
          cardType: .yellow,
          recipientType: .player),
  ...
  fileprivate static var ussf: MisconductTemplate {
    MisconductTemplate(
      id: "ussf",
      name: "USSF",
      ...
      reasons: [
        ...
        MisconductReason(
          id: "us_off",
          code: "OFFINABUS",
          title: "Offensive/Insulting/Abusive Language",
          cardType: .red,
          recipientType: .player),
  ...
  fileprivate static var footballNorthernNSW: MisconductTemplate {
    MisconductTemplate(
      id: "football_nnswf",
  ...
  fileprivate static var footballQueensland: MisconductTemplate {
    MisconductTemplate(
      id: "football_qld",

...
protocol SupabaseCompetitionLibraryServing {
    ...
    func fetchCompetitions(ownerId: UUID, updatedAfter: Date?) async throws -> [SupabaseCompetitionLibraryAPI.RemoteCompetition]

    /// Sync a competition to Supabase (upsert)
    func syncCompetition(_ request: SupabaseCompetitionLibraryAPI.CompetitionRequest) async throws -> SupabaseCompetitionLibraryAPI.SyncResult

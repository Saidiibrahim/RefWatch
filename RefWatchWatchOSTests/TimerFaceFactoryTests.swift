...
final class TimerFaceFactoryTests: XCTestCase {
    override func setUpWithError() throws {
        throw XCTSkip("TODO: watch simulator host fails to launch for TimerFaceFactoryTests; investigate paired device requirements / launch error 'Simulator device failed to launch com.IbrahimSaidi.RefWatch.watchkitapp'.")
    }

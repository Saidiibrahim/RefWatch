        ...
        if self.authController.isSignedIn {
          List {
            Section("Overview (Last 20 Matches)") {
              self.metricRow(title: "Average Cards", value: "3.2")
              self.metricRow(title: "Average Stoppage (min)", value: "5.4")
              self.metricRow(title: "Penalty Conversion", value: "78%")
            }

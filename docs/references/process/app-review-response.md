...
• Match Mode runtime behavior is best‑effort within watchOS system policies. If the system returns to the watch face, reopening the app resumes the in-progress match state without creating a HealthKit workout.

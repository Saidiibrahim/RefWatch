# RefWatch Documentation Hub

Welcome to the RefWatch knowledge base. This folder complements the generated API documentation in ``Documentation/RefWatch.docc`` and keeps project processes in one place.

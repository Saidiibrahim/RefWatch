...
final class SignedOutGateUITests: XCTestCase {
    ...
    func testGate_whenSignedOut_showsBlockingExperience() {
        ...
        XCTAssertTrue(app.staticTexts["RefZone on iPhone now requires a Supabase account. Sign in to access match tools, schedules, trends, and team management."].exists)
